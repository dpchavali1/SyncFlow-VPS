...
// Cache management: use the LRU-based WebCacheManager from '@/lib/cache'
// instead of this file. The duplicate class that was here has been removed
// in favour of the more sophisticated implementation with LRU eviction,
// prefix invalidation, and access-order tracking.
// See: import { cacheManager } from '@/lib/cache'
